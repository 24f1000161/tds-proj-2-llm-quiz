...
async def solve_with_llm(
    ...
    # FIX #4: Don't use generic 'start' fallback - raise exception
    logger.error("   ❌ No answer generated by any handler")
    raise Exception(
        "No answer generated. Check task classification and handler implementation."
    )
